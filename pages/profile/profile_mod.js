import { find_name_from_username, find_user_profile, write_user_profile } from "../../index.js";

var username = localStorage.getItem("username_x")

document.getElementById("profile_form").addEventListener("submit", update_user_database)
...
function update_user_database() { 
    ...
    write_user_profile(username, displayname, age, bio, cca, comfort, convenience, degree, facebook, instagram, linkedin, location_user, mbti, price, speed, rs_status, year)
}